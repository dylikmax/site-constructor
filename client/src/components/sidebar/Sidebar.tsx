...
import { ImageIcon, LayersIcon, PlusIcon, SettingsIcon } from "../../assets/icons"
import { CategoryButton } from "./CategoryButton";
import type { Category } from "./category.interface";
import { BaseCategory, Components, Images, Layers, Settings } from "./categories";
...
const categories : Category[] = [
    ...
    },
    {
        ...
        {
        name: "Images",
        description: "Upload images to use these into the project.",
